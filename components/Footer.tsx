        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-14">
          ...
          <div className="grid grid-cols-2 gap-8">
            {[
              ...
              <div key={col.title}>
                <p className="text-white font-display font-semibold mb-5 text-xs uppercase tracking-widest">{col.title}</p>
          ...
          {/* Newsletter */}
          <div>
            <p className="text-white font-display font-semibold mb-2 text-xs uppercase tracking-widest">Stay in the Loop</p>
